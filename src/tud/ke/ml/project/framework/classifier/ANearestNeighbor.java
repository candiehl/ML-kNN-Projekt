...
/**
 * Abstract base class for the k-NearestNeighbour classifier. Do not modify
 * 
 * @author cwirth
 *
 */
public abstract class ANearestNeighbor {
	 ...
	 * 
	 * @param kNearest
	 *            the amount of nearest neighbors to use for voting (k)
	 */
	...
	/**
	 * Determines if inverse distance weighting or unweighed voting should be
	 * use for the voting
	 * 
	 ...
	 * @param subset
	 *            Set of nearest neighbors with their distance
	 * @return Map of classes with their votes (e.g. returnValue.get("yes") are
	 *         the votes for class "yes")
	 */
	protected abstract Map<Object, Double> getUnweightedVotes(
	 ...
	 *         the votes for class "yes")
	 */
	protected abstract Map<Object, Double> getWeightedVotes(
			List<Pair<List<Object>, Double>> subset);
	 ...
	 * 
	 * @param votesFor
	 *            List of classes with their votes (e.g. returnValue.get("yes")
	...
	/**
	 * Calculates the nearest neighbors. Must call
	 * {@link #determineManhattanDistance(List, List)} or
	 * {@link #determineEuclideanDistance(List, List)} according to
	 * {@link #getMetric()}
	 * 
	 * @param data
	 *            the current test instance
	 * @return a list of {@link #getkNearest()} nearest instances with their
	 *         according distance
	 */
	protected abstract List<Pair<List<Object>, Double>> getNearest(
	 ...
	 * @return the distance
	 */
	protected abstract double determineManhattanDistance(
			List<Object> instance1, List<Object> instance2);
	 ...
	 * @return the distance
	 */
	protected abstract double determineEuclideanDistance(
			List<Object> instance1, List<Object> instance2);

	/**
	 * Calculates the scaling and translation factor for each attribute
	 * 
	 * @return an array of all scaling factors and translation factors:
	 *         [[scaling],[translation]]
	 */
